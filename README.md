...
- `monitoring-grafana` service in namespace `monitoring` for Grafana
- `kubeview` service in namespace `kubeview` for Kubeview
...
- AlgoHive: `http://<algohive-ingress-address>`
- BeeHub: `http://<beehub-ingress-address>`
- Grafana: `http://<monitoring-grafana-loadbalancer-hostname>`
- Kubeview: `http://<kubeview-loadbalancer-hostname>:8000`
...
- Username: `admin`
- Password: value stored in GitHub Secret `GRAFANA_ADMIN_PASSWORD`
